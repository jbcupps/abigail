...
/// Internal keyring for Abby's own secrets.
///
...
/// The private key is returned as base64 for user to save; it is NOT stored by Abby.
...
/// 
/// The private key is NEVER stored by Abby. The user is responsible for
