...
//!
//! Provides a persistent job queue backed by the embedded Surreal store with
...
//! ## Architecture
//!
//! - **SurrealDB** stores job records with full lifecycle (queued → running → completed/failed)
