...
- Prefer `browser_fill_form` over `browser_click` plus `browser_type_text` for form inputs.
- Always call `browser_close` when finished to free resources.
- Use JavaScript evaluation sparingly and only when dedicated tools are insufficient.
