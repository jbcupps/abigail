...
- **Generated at first run** by the user's Abby instance
- **Private key is shown ONCE** during initial setup - user MUST save it securely
- **Private key is NEVER stored** by Abby - only the public key is retained
...
- **Immutable:** Abby refuses requests to modify constitutional docs
...
2. Abby generates Ed25519 keypair
