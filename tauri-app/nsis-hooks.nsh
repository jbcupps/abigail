...
Function BackupUserData
  ...
  ; Files: config.json, Hive-owned memory store, legacy migration inputs, external_pubkey.bin,
  ;        legacy/new vault files, docs/, and Hive files (global_settings.json, master.key,
  ;        install_upgrade_state.json, identities/)
